...
TEST(CommonArray, StringArrayTest) {
    ...
    arr_string *pArrString = readStringArr(fileName);
...
TEST(CommonArray, BoolArrayTest) {
    ...
    arr_bool *pArrBool = readBoolArr(fileName);
...
TEST(CommonArray, IntArrayTest) {
    ...
    arr_int *pArrInt = readIntArr(fileName);
...
TEST(CommonArray, LongArrayTest) {
    ...
    arr_long *pArrLong = readLongArr(fileName);
...
TEST(CommonArray, DoubleArrayTest) {
    ...
    arr_double *pArrDouble = readDoubleArr(fileName);
