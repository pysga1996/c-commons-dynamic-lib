...
TEST(CommonMatrix, BoolMatrixTest) {
    ...
    matrix_bool *pMatrixBool = readBoolMatrix(fileName);
...
TEST(CommonMatrix, LongMatrixTest) {
    ...
    matrix_long *pMatrixLong = readLongMatrix(fileName);
...
TEST(CommonMatrix, DoubleMatrixTest) {
    ...
    matrix_double *pMatrixDouble = readDoubleMatrix(fileName);
...
TEST(CommonMatrix, StringMatrixTest) {
    ...
    matrix_string *pMatrixString = readStringMatrix(fileName);
